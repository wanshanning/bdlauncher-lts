...
public:
    ...
    givecommand(CommandOrigin const &origin, CommandOutput &output) noexcept : CustomCommandContext(origin, output) {}

    void oncmd(mandatory<std::string> target, mandatory<int> id, mandatory<int> data, mandatory<int> count);
};